...
- A doubly linked list is an extension of a singly linked list. To fully grasp doubly linked lists, it is essential to understand the   concepts of singly linked lists. 
# Doubly Linked Lists
